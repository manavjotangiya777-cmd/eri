...
export default function BDELayout({ children }: BDELayoutProps) {
    ...
    return (
      <div className="flex flex-col h-full">
        <div className="p-6 border-b border-sidebar-border">
          ...
          <p className="text-xs text-sidebar-foreground/70 mt-2 font-medium tracking-wide uppercase">BDE Portal</p>
        </div>
